...
class _NowPlayingPageState extends State<NowPlayingPage> with SingleTickerProviderStateMixin{
  ...
  void initState(){
    ...
    _imageAnimController = AnimationController(vsync: this,
            ...
            child: Column(
              ...
              children: [
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage.assetNetwork(placeholder: 'assets/itunes_256.jpg',
                      image: _song.image,
                      width: screenWidth - delta,
                      height: screenWidth - delta,
                      imageErrorBuilder: (context, error, stackTrace){
                        return Image.asset('assets/itunes_256.jpg',
                        width: screenWidth - delta,
                        height: screenWidth - delta,
                        );
                      },
                ...
                Padding(padding: const EdgeInsets.only( left: 24, right: 24, bottom: 16),
                  child: _mediaButtons(),
                )
              ],
            ),
    ...
    return StreamBuilder<DurationState>(stream: _audioPlayerManager.durationState,
      builder: (context, snapshot){
       ...
       return ProgressBar(progress: progress, total: total,buffered: buffered,
          onSeek: _audioPlayerManager.player.seek, barHeight: 5.0, barCapShape: BarCapShape.round,
          baseBarColor: Colors.grey, progressBarColor: Colors.green, bufferedBarColor: Colors.grey,
          thumbColor: Colors.green, thumbRadius: 10.0,);
      });
  }
  StreamBuilder<PlayerState> _playButton(){
    return StreamBuilder(stream: _audioPlayerManager.player.playerStateStream,
        builder: (context, snapshot){
          ...
          if(processingState == ProcessingState.loading
            ...
            return MediaButtonControl(function: (){
              ...
              _resetRotationAnim();
              _playRotationAnim();
            }, icon: Icons.repeat, color: null, size: 48);
          }
        });
  }
...
class _MediaButtonControlState extends State<MediaButtonControl>{
  @override
  Widget build(BuildContext context) {
    return IconButton(onPressed: widget.function, icon: Icon(widget.icon), iconSize: widget.size,
